...
function applySecurityHeaders(response: NextResponse) {
  ...
  const cspHeader = `
    ...
    connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://region1.google-analytics.com https://*.google-analytics.com https://*.googletagmanager.com https://cdn.iframe.ly https://images.microcms-assets.io;
