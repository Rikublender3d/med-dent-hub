...
export async function POST(request: Request) {
  try {
    ...
    const pdfBlock = `<p style="margin:16px 0; font-size:14px; color:#495057;">登録特典の<strong>医科歯科連携マニュアル＆フォーマット</strong>（PDF）は現在制作中のため、完成次第メールにてお送りいたします。もうしばらくお待ちください。</p>`
