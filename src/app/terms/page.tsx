    ...
    <div className="min-h-screen bg-white py-12">
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <section className="mb-10">
          ...
          <p className="mb-4 leading-7 text-[color:var(--foreground)]">
        ...
        <section className="mb-10">
          ...
          <p className="mt-4 leading-7 text-[color:var(--foreground)]">
        ...
        <section className="mb-10">
          <h2 className="mb-3 text-xl font-semibold">第7条（退会）</h2>
          <p className="leading-7 text-[color:var(--foreground)]">
        ...
        <section className="mb-10">
          ...
          <p className="mt-4 leading-7 text-[color:var(--foreground)]">
            当サイトはユーザーに対し、前項による本規約の変更にあたり、事前に、本規約を変更する旨及び変更後の本規約の内容並びにその効力発生時期を通知いたします。
          </p>
        </section>
